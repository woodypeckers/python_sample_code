...
class SimpleAndroidTests(unittest.TestCase):
    ...
    def test_find_elements(self):
        ...
        print self.driver.find_element_by_android_uiautomator('text("API Demos")')
    ...
    def test_diy_actions(self):
        els = self.driver.find_elements_by_id("android:id/text1")
        els[6].click()
    ...
    def test_find_element_by_xpath(self):
        els = self.driver.find_element_by_xpath("//android.widget.TextView[contains(@content-desc, 'Animation')]")
        els.click()
        sleep(3)
