...
case1_log
    [Tags]    logtest
    set log level    trace
    Log    hello <b>world!</b> debug    level=debug    html=yes    console=yes
...
case4_Add_Scalar_List
    ...
    #log    @{list_var1}
    log many    @{list_var1}
    @{name_list}    create list    wang    jin ling
    log many    @{name_list}
...
case7_Number
    ...
    @{list_num1}=    set variable    ${3.14159}    3.14159
